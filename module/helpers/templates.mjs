...
export const preloadHandlebarsTemplates = async function () {
  return loadTemplates([
    // Actor partials.
    'systems/foundry-quintessence-system/templates/actor/parts/actor-features.hbs',
    'systems/foundry-quintessence-system/templates/actor/parts/actor-items.hbs',
    'systems/foundry-quintessence-system/templates/actor/parts/actor-spells.hbs',
